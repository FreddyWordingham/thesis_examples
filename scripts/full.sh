...
mv output/diffuse/oxy/008_diff.nc input/res/maps/oxy_init.nc;
...
mv output/reactor/ppix/008_\{ppix\}_diff.nc input/res/maps/ppix_init.nc
mv output/reactor/ppix/008_\{ala\}_diff.nc input/res/maps/ala_init_2.nc
